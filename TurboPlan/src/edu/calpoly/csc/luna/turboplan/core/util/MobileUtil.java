...
public class MobileUtil {
	...
	private static MobileTask hib2mobileTask(Task entity) {
		...
		if(entity.getLocation() != null) {
			...
			mTask.setLocation(hib2mobileAddress(new Address()));
		}
		...
		if(entity.getTimespent() != null) {
			mTask.setTimespent(new Long(Math.round(entity.getTimespent())));
		} else {
			mTask.setTimespent(0L);
		}
