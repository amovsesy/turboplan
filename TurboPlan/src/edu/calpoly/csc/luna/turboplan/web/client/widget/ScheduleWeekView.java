...
public class ScheduleWeekView extends ScheduleGrid {
	...
	public ScheduleWeekView(){
		super(new RecordDef(new FieldDef[] {
				...
				new ColumnConfig("Thursday", THURSDAY_RECORDDEF, 98, false, new AvialRender("thurs")),
	...
	/**
	 * Inputs the data into the grid with the current week.
	 */
	private void displayWeek(){
		...
		setTitle(fullDateFormatter.format(sun) + " - " + fullDateFormatter.format(sat));
    ...
    private void setupButtons() {
        ...
        prev.addListener(new ButtonListenerAdapter() {
            public void onClick(Button button, EventObject e) {
                ...
                sun = new Date(sun.getTime() - dateMill*7); 
                sat = new Date(sat.getTime() - dateMill*7); 
	...
	public boolean isInWeek(Date start, Date end){
		...
		Log.trace("Not in this week not null");	
