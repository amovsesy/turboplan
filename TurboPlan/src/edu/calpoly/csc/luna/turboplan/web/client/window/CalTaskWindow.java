...
/**
	...
	public CalTaskWindow(String title) {
        super();
        this.setTitle(title);
        this.tPanel = new TaskProfilePanel(false);
    ...
    public CalTaskWindow(String title, GwtTask curTask) {
        super();
        this.setTitle(title);
        this.tPanel = new TaskProfilePanel(true);
        this.setupAttributes();
        this.task = curTask;
        this.setupButtons();
    }
     ...
     */
    public CalTaskWindow(String title, Button[] buttonBar, boolean showAssigned) {
        super();
        this.setTitle(title);
        this.tPanel = new TaskProfilePanel(showAssigned);
        this.setupAttributes();
