...
//    private TextField owner;
    ...
    public Panel buildTimePanel() {
        ...
        //Create Fields
        startDateField = new DateField("Start Date*", "startDate", dateFieldWidth);     
        endDateField = new DateField("End Date*", "endDate", dateFieldWidth);
        startTimeField = new TimeField("Start Time*", "startTime", timeFieldWidth);
        endTimeField = new TimeField("End Time*", "endTime", timeFieldWidth);
...
//    }
    ...
    public void setTaskProfile(GwtTask task) {
        ...
        startDateField.setValue(dateFormatter.format(task.getSuggestedStartTime()));
        endDateField.setValue(dateFormatter.format(task.getSuggestedEndTime()));
        startTimeField.setValue(timeFormatter.format(task.getSuggestedStartTime()));
        endTimeField.setValue(timeFormatter.format(task.getSuggestedEndTime()));
...
//        profile.setUsers(new Set<GwtUser> = { owner.getT)   NEED TO GET USER
        ...
        if (!tempstate.equals("")) {
        	customerAddress.setState(tempAd);
        }
